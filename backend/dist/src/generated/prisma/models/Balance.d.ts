...
export type GetBalanceAggregateType<T extends BalanceAggregateArgs> = {
    [P in keyof T & keyof AggregateBalance]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateBalance[P]> : Prisma.GetScalarType<T[P], AggregateBalance[P]>;
};
...
export type GetBalanceGroupByPayload<T extends BalanceGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<BalanceGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof BalanceGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], BalanceGroupByOutputType[P]> : Prisma.GetScalarType<T[P], BalanceGroupByOutputType[P]>;
}>>;
...
export type BalanceCreateNestedOneWithoutWorkerInput = {
    create?: Prisma.XOR<Prisma.BalanceCreateWithoutWorkerInput, Prisma.BalanceUncheckedCreateWithoutWorkerInput>;
    connectOrCreate?: Prisma.BalanceCreateOrConnectWithoutWorkerInput;
    connect?: Prisma.BalanceWhereUniqueInput;
};
export type BalanceUncheckedCreateNestedOneWithoutWorkerInput = {
    create?: Prisma.XOR<Prisma.BalanceCreateWithoutWorkerInput, Prisma.BalanceUncheckedCreateWithoutWorkerInput>;
    connectOrCreate?: Prisma.BalanceCreateOrConnectWithoutWorkerInput;
    connect?: Prisma.BalanceWhereUniqueInput;
};
export type BalanceUpdateOneWithoutWorkerNestedInput = {
    create?: Prisma.XOR<Prisma.BalanceCreateWithoutWorkerInput, Prisma.BalanceUncheckedCreateWithoutWorkerInput>;
    connectOrCreate?: Prisma.BalanceCreateOrConnectWithoutWorkerInput;
    upsert?: Prisma.BalanceUpsertWithoutWorkerInput;
...
export type BalanceUncheckedUpdateOneWithoutWorkerNestedInput = {
    create?: Prisma.XOR<Prisma.BalanceCreateWithoutWorkerInput, Prisma.BalanceUncheckedCreateWithoutWorkerInput>;
    connectOrCreate?: Prisma.BalanceCreateOrConnectWithoutWorkerInput;
    upsert?: Prisma.BalanceUpsertWithoutWorkerInput;
    disconnect?: Prisma.BalanceWhereInput | boolean;
...
export type BalanceUpsertWithoutWorkerInput = {
    update: Prisma.XOR<Prisma.BalanceUpdateWithoutWorkerInput, Prisma.BalanceUncheckedUpdateWithoutWorkerInput>;
    create: Prisma.XOR<Prisma.BalanceCreateWithoutWorkerInput, Prisma.BalanceUncheckedCreateWithoutWorkerInput>;
    where?: Prisma.BalanceWhereInput;
};
export type BalanceUpdateToOneWithWhereWithoutWorkerInput = {
    where?: Prisma.BalanceWhereInput;
...
export type BalanceOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "pending_amount" | "locked_amount" | "workerId", ExtArgs["result"]["balance"]>;
...
export type BalanceCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<BalanceFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BalanceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends BalanceCountArgs>(args?: Prisma.Subset<T, BalanceCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], BalanceCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends BalanceGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, BalanceGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBalanceGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
